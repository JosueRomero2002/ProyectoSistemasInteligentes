...
# Print image as matrix from 0 to 255
print(mnist_train.images[9] / 255)


# La imagen que vamos a desplegar
# reshape image to 28x28
# image = mnist_train.images[0].reshape(28, 28)
# displayImage(image, "MNIST Image 1")
